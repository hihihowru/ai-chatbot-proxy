...
### MVP 層級結構 (MVP Hierarchy)
```
股票分析助手 - MVP 版本
├── 核心頁面 (v0 MVP)
│   ├── 首頁 (/) 
│   │   ├── 盤前時段 (06:00-09:00) - 國際股市、台指期、隔日沖分析
│   │   ├── 盤中時段 (09:00-13:30) - 即時監控、持股縮圖、異動提醒
│   │   └── 盤後時段 (13:30-06:00) - 今日總結、持股健康、籌碼分析
│   ├── 對話頁面 (/chat)
│   │   ├── 多股 sections (自選股摘要)
│   │   ├── 單股 sections (個股分析)
│   │   ├── 新聞資訊整合
...
- **2025-07-07**: 初始版本
- **2025-07-07**: 加入時段導向設計
- **2025-07-07**: 新增 Pin 功能和 Section 互動
- **2025-07-07**: 優化盤前時段內容架構
- **2025-07-07**: 加入版本規劃 (v0 MVP / v1 MVP / v2 MVP / v3 MVP)
- **2025-07-07**: 新增對話頁面互動功能 (按讚/倒讚、Copy、Feedback、Regenerate)
- **2025-07-07**: 新增三面分析 (籌碼面、基本面、技術面) 與具體圖表規劃
- **2025-07-07**: 移除收藏內容功能 (與 Pinned Chats 重疊)
- **2025-07-07**: 新增網站架構圖 (Flowchart、Mindmap、Hierarchy)
- **2025-07-07**: 新增搜尋功能、數據分析、警報系統等缺失功能
- **2025-07-07**: 新增搜尋智能建議系統 (股票建議、問題建議、歷史對話建議)
- **2025-07-07**: 調整功能規劃時程，產業分析移至 Phase 4
- **2025-07-07**: 新增會員系統規劃，移除獨立新聞/輿情頁面
- **2025-07-07**: 修正 Mermaid 語法錯誤和格式問題
- **2025-07-07**: 調整 v0/v1 MVP 功能分配
  - 個股分析頁面移至 v1 MVP
  - 財報資料、籌碼資料移至 v0 MVP
