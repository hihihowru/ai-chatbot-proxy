...
```mermaid
journey
    title 盤後時段用戶心理狀態 (16:00-18:00)
    section 啟動總結
      下班後，時間相對充裕 (16:00-16:05): 4: 使用者
      需要總結今日表現 (16:00-16:05): 5: 使用者
    section 健康評估
      查看健康度，評估風險 (16:05-16:15): 4: 使用者
      發現問題，產生擔憂 (16:05-16:15): 2: 使用者
    section 深度分析
      深入分析，尋找原因 (16:15-16:25): 4: 使用者
      學習知識，提升能力 (16:15-16:25): 3: 使用者
    section 策略規劃
      制定策略，建立信心 (16:25-16:30): 4: 使用者
      規劃明日，準備就緒 (16:25-16:30): 5: 使用者
```
