...
[micromark](https://github.com/micromark/micromark) utility to decode numeric character references.
...
This module exports the identifier: [`decodeNumericCharacterReference`](./#decodenumericcharacterreferencevalue-base). There is no default export.
